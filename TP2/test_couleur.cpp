...
**/
void getComposante(OCTET* imgIn, OCTET* ImgComp, int comp){
...
int main(int argc, char* argv[])
{
  ...
  if (argc != 4) 
   ...
   OCTET *ImgIn, *ImgOut, *ImgTempR, *ImgTempB;
   ...
   allocation_tableau(ImgOut, OCTET, nTaille3);
	   allocation_tableau(ImgTempR, OCTET, nTaille);
        allocation_tableau(ImgTempB, OCTET, nTaille);
