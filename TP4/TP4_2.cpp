...
printf("a1\n");
remplirPalette(palette, taillePalette);
printf("a2\n");
parcoursK_mean(nTaille, ImgIn, ImgIndex, palette, sommeC, nbC, taillePalette);
printf("a3\n");
convertIndexToRGB(nTaille, ImgIndex, ImgOut, palette);
printf("a4\n");
char nomOut1[250]= "5_out_1.ppm";
...
printf("a5\n");
 parcoursMoyenneK_mean(paletteMoy, sommeC, nbC, taillePalette);
 printf("a6\n");
convertIndexToRGB(nTaille, ImgIndex, ImgOut, paletteMoy);
printf("a7\n");
 char nomOut2[250]= "5_out_2.ppm";
  ecrire_image_ppm(nomOut2, ImgOut, nH, nW);

convergence( nTaille, ImgIn, ImgIndex,  palette, paletteMoy,  sommeC,  nbC,  taillePalette);

convertIndexToRGB(nTaille, ImgIndex, ImgOut, paletteMoy);
char nomOut3[250]= "5_out_3.ppm";
